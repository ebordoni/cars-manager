...
[![Version](https://img.shields.io/badge/version-1.0.0-green)](cars-manager/CHANGELOG.md)
...
| ----------------------------- | -------- | ----------------------------------------------------------- |
| [Cars Manager](cars-manager/) | 1.0.0    | Gestione garage, scadenze, documenti, guasti e reportistica |
...
Archivia libretti, polizze assicurative, fatture di officina in formato PDF, JPG, PNG, DOCX.
